...
public class ItemController {
    ...
    public ItemDto create(@RequestHeader("X-Sharer-User-Id") long sharerId,
                          @RequestBody ItemDtoParam itemDtoParam) {
        return itemService.create(sharerId, itemDtoParam);
    }
    ...
    public CommentDto createComment(@RequestHeader("X-Sharer-User-Id") long sharerId,
                                    @PathVariable Long itemId,
                                    @RequestBody CommentParamDto commentParamDto) {
        return itemService.createComment(sharerId, itemId, commentParamDto);
    }
